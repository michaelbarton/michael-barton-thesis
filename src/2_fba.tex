...
The cost of producing an amino acid using the above described method was applied to all twenty amino acids in four differnt nutrient limiting environments: glucose, ammonium, sulphate, and phosphate. The estimated costs for each of these amino acids is illustrated in Figure~\vref{figure:costs_dendrogram_dotplot} along with other costs previously described in the literature.
